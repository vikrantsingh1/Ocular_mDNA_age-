######################################################
###code is adapted from Steve Horvath code for 
###estimating DNA methylation age with R.
#####################################################
...
library(impute)
library(parallel)
source("/Users/vikrants/Desktop/DNAmage/NORMALIZATION.R")

setwd("/Users/vikrants/Desktop/DNAmage/")
...
set.seed(1)
normalizeData=TRUE
source("/Users/vikrants/Desktop/DNAmage/StepwiseAnalysis.txt")
